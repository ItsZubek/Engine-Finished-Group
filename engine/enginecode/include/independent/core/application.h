...
#pragma region TempVars
		...
		std::shared_ptr<VertexArray> m_RenderVAO;
		std::shared_ptr<Texture> m_RenderTexture;
		std::shared_ptr<Material> m_renderMaterial;

		std::shared_ptr<VertexArray> m_RenderVAO1;
		std::shared_ptr<Texture> m_RenderTexture1;
		std::shared_ptr<Material> m_renderMaterial1;

		std::shared_ptr<VertexArray> m_RenderVAO2;
		std::shared_ptr<Texture> m_RenderTexture2;
		std::shared_ptr<Material> m_renderMaterial2;
